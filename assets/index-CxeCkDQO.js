 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var lg;function YE(){if(lg)return Ca;lg=1;var r=Zd(),e=Symbol.for("react.element"),t=Symbol.for("react.fragment"),s=Object.prototype.hasOwnProperty,o=r.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,l={key:!0,ref:!0,__self:!0,__source:!0};function h(f,p,y){var w,T={},R=null,V=null;y!==void 0&&(R=""+y),p.key!==void 0&&(R=""+p.key),p.ref!==void 0&&(V=p.ref);for(w in p)s.call(p,w)&&!l.hasOwnProperty(w)&&(T[w]=p[w]);if(f&&f.defaultProps)for(w in p=f.defaultProps,p)T[w]===void 0&&(T[w]=p[w]);return{$$typeof:e,type:f,key:R,ref:V,props:T,_owner:o.current}}return Ca.Fragment=t,Ca.jsx=h,Ca.jsxs=h,Ca}var ug;function XE(){return ug||(ug=1,od.exports=YE()),od.exports}var Re=XE(),q=Zd(),Su={},ld={exports:{}},Jt={},ud={exports:{}},cd={};/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Tn(u0,c0,"app");const E_="@firebase/installations",lf="0.6.11";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const T_=1e4,I_=`w:${lf}`,S_="FIS_v2",h0="https://firebaseinstallations.googleapis.com/v1",d0=60*60*1e3,f0="installations",p0="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const P0="firebase-installations-database",C0=1,ss="firebase-installations-store";let _d=null;function uf(){return _d||(_d=y_(P0,C0,{upgrade:(r,e)=>{switch(e){case 0:r.createObjectStore(ss)}}})),_d}async function Qu(r,e){const t=gc(r),o=(await uf()).transaction(ss,"readwrite"),l=o.objectStore(ss),h=await l.get(t);return await l.put(e,t),await o.done,(!h||h.fid!==e.fid)&&V_(r,e.fid),e}async function O_(r){const e=gc(r),s=(await uf()).transaction(ss,"readwrite");await s.objectStore(ss).delete(e),await s.done}async function yc(r,e){const t=gc(r),o=(await uf()).transaction(ss,"readwrite"),l=o.objectStore(ss),h=await l.get(t),f=e(h);return f===void 0?await l.delete(t):await l.put(f,t),await o.done,f&&(!h||h.fid!==f.fid)&&V_(r,f.fid),f}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $g(r){let e=0;for(const t in r)Object.prototype.hasOwnProperty.call(r,t)&&e++;return e}function ds(r,e){for(const t in r)Object.prototype.hasOwnProperty.call(r,t)&&e(t,r[t])}function X_(r){for(const e in r)if(Object.prototype.hasOwnProperty.call(r,e))return!1;return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function vf(r,e){if(r.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:Xu(e)?"-0":e}}function hv(r){return{integerValue:""+r}}function _A(r,e){return HR(e)?hv(e):vf(r,e)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Mr(r,...e){throw $f(r,...e)}function nr(r,...e){return $f(r,...e)}function mw(r,e,t){const s=Object.assign(Object.assign({},$C()),{[e]:t});return new cs("auth","Firebase",s).create(e,{appName:r.name})}function rs(r){return mw(r,"operation-not-supported-in-this-environment","Operations that alter the current user are not supported in conjunction with FirebaseServerApp")}function $f(r,...e){if(typeof r!="string"){const t=e[0],s=[...e.slice(1)];return s[0]&&(s[0].appName=r.name),r._errorFactory.create(t,...s)}return pw.create(r,...e)}function ve(r,e,...t){if(!r)throw $f(e,...t)}function Cr(r){const e="INTERNAL ASSERTION FAILED: "+r;throw ju(e),new Error(e)}function br(r,e){r||Cr(e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ew{constructor(){this.type="NONE",this.storage={}}async _isAvailable(){return!0}async _set(e,t){this.storage[e]=t}async _get(e){const t=this.storage[e];return t===void 0?null:t}async _remove(e){delete this.storage[e]}_addListener(e,t){}_removeListener(e,t){}}Ew.type="NONE";const Cy=Ew;/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Nw(r,e=[]){let t;switch(r){case"Browser":t=ky(zt());break;case"Worker":t=`${ky(zt())}-${r}`;break;default:t=r}const s=e.length?e.join(","):"FirebaseCore-web";return`${t}/JsCore/${Co}/${s}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Sk(r,e,t=!1){const{auth:s}=r;if(pi(s.app))return Promise.reject(rs(s));const o="reauthenticate";try{const l=await Ya(r,Lw(s,o,e,r),t);ve(l.idToken,s,"internal-error");const h=Wf(l.idToken);ve(h,s,"internal-error");const{sub:f}=h;return ve(r.uid===f,s,"user-mismatch"),Ro._forOperation(r,o,l)}catch(l){throw(l==null?void 0:l.code)==="auth/user-not-found"&&Mr(s,"user-mismatch"),l}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
