 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var ug;function YE(){if(ug)return Ca;ug=1;var r=Zd(),e=Symbol.for("react.element"),t=Symbol.for("react.fragment"),s=Object.prototype.hasOwnProperty,o=r.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,l={key:!0,ref:!0,__self:!0,__source:!0};function h(f,p,y){var w,T={},R=null,V=null;y!==void 0&&(R=""+y),p.key!==void 0&&(R=""+p.key),p.ref!==void 0&&(V=p.ref);for(w in p)s.call(p,w)&&!l.hasOwnProperty(w)&&(T[w]=p[w]);if(f&&f.defaultProps)for(w in p=f.defaultProps,p)T[w]===void 0&&(T[w]=p[w]);return{$$typeof:e,type:f,key:R,ref:V,props:T,_owner:o.current}}return Ca.Fragment=t,Ca.jsx=h,Ca.jsxs=h,Ca}var cg;function XE(){return cg||(cg=1,od.exports=YE()),od.exports}var Ie=XE(),q=Zd(),Su={},ld={exports:{}},Jt={},ud={exports:{}},cd={};/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class TR{constructor(e){this.app=e}_delete(){return delete Oa[this.app.options.appId],Promise.resolve()}}let Oa={},Og=[];const Mg={};let wd="dataLayer",IR="gtag",bg,B_,Fg=!1;function SR(){const r=[];if(d_()&&r.push("This is a browser extension environment."),HI()||r.push("Cookies are not available."),r.length>0){const e=r.map((s,o)=>`(${o+1}) ${s}`).join(" "),t=cn.create("invalid-analytics-context",{errorInfo:e});en.warn(t.message)}}function RR(r,e,t){SR();const s=r.options.appId;if(!s)throw cn.create("no-app-id");if(!r.options.apiKey)if(r.options.measurementId)en.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${r.options.measurementId} provided in the "measurementId" field in the local Firebase config.`);else throw cn.create("no-api-key");if(Oa[s]!=null)throw cn.create("already-exists",{id:s});if(!Fg){iR(wd);const{wrappedGtag:l,gtagCore:h}=lR(Oa,Og,Mg,wd,IR);B_=l,bg=h,Fg=!0}return Oa[s]=ER(r,Og,Mg,e,bg,wd,t),new TR(r)}function AR(r=lf()){r=tn(r);const e=hs(r,Yu);return e.isInitialized()?e.getImmediate():PR(r)}function PR(r,e={}){const t=hs(r,Yu);if(t.isInitialized()){const o=t.getImmediate();if(Ba(e,t.getOptions()))return o;throw cn.create("already-initialized")}return t.initialize({options:e})}function CR(r,e,t,s){r=tn(r),vR(B_,Oa[r.app.options.appId],e,t,s).catch(o=>en.error(o))}const Ug="@firebase/analytics",zg="0.10.10";function kR(){sr(new zn(Yu,(e,{options:t})=>{const s=e.getProvider("app").getImmediate(),o=e.getProvider("installations-internal").getImmediate();return RR(s,o,t)},"PUBLIC")),sr(new zn("analytics-internal",r,"PRIVATE")),Tn(Ug,zg),Tn(Ug,zg,"esm2017");function r(e){try{const t=e.getProvider(Yu).getImmediate();return{logEvent:(s,o,l)=>CR(t,s,o,l)}}catch(t){throw cn.create("interop-component-reg-failed",{reason:t})}}}kR();var jg=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Rk(r,e,t=!1){if(pi(r.app))return Promise.reject(rs(r));const s="signIn",o=await Lw(r,s,e),l=await Ro._fromIdTokenResponse(r,s,o);return t||await r._updateCurrentUser(l.user),l}function Ak(r,e,t,s){return tn(r).onIdTokenChanged(e,t,s)}function Pk(r,e,t){return tn(r).beforeAuthStateChanged(e,t)}function Ck(r,e,t,s){return tn(r).onAuthStateChanged(e,t,s)}const cc="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Qk="pendingRedirect",$u=new Map;class Yk extends $w{constructor(e,t,s=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],t,void 0,s),this.eventId=null}async execute(){let e=$u.get(this.auth._key());if(!e){try{const s=await Xk(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(s)}catch(t){e=()=>Promise.reject(t)}$u.set(this.auth._key(),e)}return this.bypassAuthState||$u.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const t=await this.auth._redirectUserForId(e.eventId);if(t)return this.user=t,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function Xk(r,e){const t=e1(e),s=Zk(r);if(!await s._isAvailable())return!1;const o=await s._get(t)==="true";return await s._remove(t),o}function Jk(r,e){$u.set(r._key(),e)}function Zk(r){return Nr(r._redirectPersistence)}function e1(r){return Bu(Qk,r.config.apiKey,r.name)}async function t1(r,e,t=!1){if(pi(r.app))return Promise.reject(rs(r));const s=Qf(r),o=qk(s,e),h=await new Yk(s,o,t).execute();return h&&!t&&(delete h.user._redirectEventId,await s._persistUserIfCurrent(h.user),await s._setRedirectUser(null,e)),h}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function s1(r,e={}){return Vo(r,"GET","/v1/projects",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const c1=new ol(3e4,6e4);function by(){const r=rr().___jsl;if(r!=null&&r.H){for(const e of Object.keys(r.H))if(r.H[e].r=r.H[e].r||[],r.H[e].L=r.H[e].L||[],r.H[e].r=[...r.H[e].L],r.CP)for(let t=0;t<r.CP.length;t++)r.CP[t]=null}}function h1(r){return new Promise((e,t)=>{var s,o,l;function h(){by(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{by(),t(nr(r,"network-request-failed"))},timeout:c1.get()})}if(!((o=(s=rr().gapi)===null||s===void 0?void 0:s.iframes)===null||o===void 0)&&o.Iframe)e(gapi.iframes.getContext());else if(!((l=rr().gapi)===null||l===void 0)&&l.load)h();else{const f=gk("iframefcb");return rr()[f]=()=>{gapi.load?h():t(nr(r,"network-request-failed"))},pk(`${mk()}?onload=${f}`).catch(p=>t(p))}}).catch(e=>{throw qu=null,e})}let qu=null;function d1(r){return qu=qu||h1(r),qu}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const f1=new ol(5e3,15e3),p1="__/auth/iframe",m1="emulator/auth/iframe",g1={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},y1=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function _1(r){const e=r.config;ve(e.authDomain,r,"auth-domain-config-required");const t=e.emulator?Hf(e,m1):`https://${r.config.authDomain}/${p1}`,s={apiKey:e.apiKey,appName:r.name,v:Co},o=y1.get(r.config.apiHost);o&&(s.eid=o);const l=r._getFrameworks();return l.length&&(s.fw=l.join(",")),`${t}?${el(s).slice(1)}`}async function v1(r){const e=await d1(r),t=rr().gapi;return ve(t,r,"internal-error"),e.open({where:document.body,url:_1(r),messageHandlersFilter:t.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:g1,dontclear:!0},s=>new Promise(async(o,l)=>{await s.restyle({setHideOnLeave:!1});const h=nr(r,"network-request-failed"),f=rr().setTimeout(()=>{l(h)},f1.get());function p(){rr().clearTimeout(f),o(s)}s.ping(p).then(p,()=>{l(h)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ad="webStorageSupport";class D1{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=Fw,this._completeRedirectFn=t1,this._overrideRedirectResult=Jk}async _openPopup(e,t,s,o){var l;br((l=this.eventManagers[e._key()])===null||l===void 0?void 0:l.manager,"_initialize() not called before _openPopup()");const h=await Uy(e,t,s,Yd(),o);return R1(e,h,Xf())}async _openRedirect(e,t,s,o){await this._originValidation(e);const l=await Uy(e,t,s,Yd(),o);return Lk(l),new Promise(()=>{})}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:o,promise:l}=this.eventManagers[t];return o?Promise.resolve(o):(br(l,"If manager is not set, promise should be"),l)}const s=this.initAndGetManager(e);return this.eventManagers[t]={promise:s},s.catch(()=>{delete this.eventManagers[t]}),s}async initAndGetManager(e){const t=await v1(e),s=new r1(e);return t.register("authEvent",o=>(ve(o==null?void 0:o.authEvent,e,"invalid-auth-event"),{status:s.onEvent(o.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:s},this.iframes[e._key()]=t,s}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send(Ad,{type:Ad},o=>{var l;const h=(l=o==null?void 0:o[0])===null||l===void 0?void 0:l[Ad];h!==void 0&&t(!!h),Mr(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=l1(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return kw()||Iw()||Gf()}}const x1=D1;var zy="@firebase/auth",jy="1.8.1";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function L1(r){switch(r){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function O1(r){sr(new zn("auth",(e,{options:t})=>{const s=e.getProvider("app").getImmediate(),o=e.getProvider("heartbeat"),l=e.getProvider("app-check-internal"),{apiKey:h,authDomain:f}=s.options;ve(h&&!h.includes(":"),"invalid-api-key",{appName:s.name});const p={apiKey:h,authDomain:f,clientPlatform:r,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:Nw(r)},y=new dk(s,o,l,p);return _k(y,t),y},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,t,s)=>{e.getProvider("auth-internal").initialize()})),sr(new zn("auth-internal",e=>{const t=Qf(e.getProvider("auth").getImmediate());return(s=>new V1(s))(t)},"PRIVATE").setInstantiationMode("EXPLICIT")),Tn(zy,jy,L1(r)),Tn(zy,jy,"esm2017")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const M1=5*60,b1=h_("authIdTokenMaxAge")||M1;let By=null;const F1=r=>async e=>{const t=e&&await e.getIdTokenResult(),s=t&&(new Date().getTime()-Date.parse(t.issuedAtTime))/1e3;if(s&&s>b1)return;const o=t==null?void 0:t.token;By!==o&&(By=o,await fetch(r,{method:o?"POST":"DELETE",headers:o?{Authorization:`Bearer ${o}`}:{}}))};function U1(r=lf()){const e=hs(r,"auth");if(e.isInitialized())return e.getImmediate();const t=yk(r,{popupRedirectResolver:x1,persistence:[$k,Dk,Fw]}),s=h_("authTokenSyncURL");if(s&&typeof isSecureContext=="boolean"&&isSecureContext){const l=new URL(s,location.origin);if(location.origin===l.origin){const h=F1(l.toString());Pk(t,h,()=>h(t.currentUser)),Ak(t,f=>h(f))}}const o=u_("auth");return o&&vk(t,`http://${o}`),t}function z1(){var r,e;return(e=(r=document.getElementsByTagName("head"))===null||r===void 0?void 0:r[0])!==null&&e!==void 0?e:document}fk({loadJS(r){return new Promise((e,t)=>{const s=document.createElement("script");s.setAttribute("src",r),s.onload=e,s.onerror=o=>{const l=nr("internal-error");l.customData=o,t(l)},s.type="text/javascript",s.charset="UTF-8",z1().appendChild(s)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});O1("Browser");const j1={apiKey:"AIzaSyCpBWqyXUXXFbxUQ-BX6Fo7_wYzee-pf6I",authDomain:"hydrojugassessment.firebaseapp.com",projectId:"hydrojugassessment",storageBucket:"hydrojugassessment.firebasestorage.app",messagingSenderId:"1063232022331",appId:"1:1063232022331:web:655dceab106076c53df91e",measurementId:"G-YVC2GTPTZ4"},Zf=__(j1);AR(Zf);const ep=TC(Zf),B1=U1(Zf),Hw=EC(ep,"products");async function $1(r){try{return(await jC(Hw,r)).id}catch(e){throw console.error("Error creating product:",e),e}}async function $y(){try{return(await UC(Hw)).docs.map(e=>({id:e.id,...e.data()}))}catch(r){throw console.error("Error fetching products:",r),r}}async function q1(r){try{const e=bf(ep,"products",r),t=await FC(e);return t.exists()?{id:t.id,...t.data()}:null}catch(e){throw console.error("Error fetching product:",e),e}}async function H1(r){try{const e=bf(ep,"products",r);await zC(e)}catch(e){throw console.error("Error deleting product:",e),e}}const W1=()=>{const[r,e]=q.useState([]),t=tf();q.useEffect(()=>{(async()=>{const h=await $y();e(h)})()},[]);const s=l=>{t(`/edit/${l}`)};async function o(l){try{await H1(l),alert("Product deleted successfully!");const h=await $y();e(h)}catch(h){alert("Error deleting product:",h.message)}}return Ie.jsxs("div",{children:[Ie.jsx("h1",{children:"Product List"}),Ie.jsx("ul",{children:r.map(l=>Ie.jsxs("li",{children:[Ie.jsx("p",{children:l.ProductName}),Ie.jsx("p",{children:l.ProductDesc}),Ie.jsx("p",{children:l.ProductPrice}),Ie.jsx("button",{onClick:()=>s(l.id),children:"Edit"}),Ie.jsx("button",{onClick:()=>o(l.id),children:"Delete"})]},l.id))})]})},Pt=[];for(let r=0;r<256;++r)Pt.push((r+256).toString(16).slice(1));function K1(r,e=0){return(Pt[r[e+0]]+Pt[r[e+1]]+Pt[r[e+2]]+Pt[r[e+3]]+"-"+Pt[r[e+4]]+Pt[r[e+5]]+"-"+Pt[r[e+6]]+Pt[r[e+7]]+"-"+Pt[r[e+8]]+Pt[r[e+9]]+"-"+Pt[r[e+10]]+Pt[r[e+11]]+Pt[r[e+12]]+Pt[r[e+13]]+Pt[r[e+14]]+Pt[r[e+15]]).toLowerCase()}let Pd;const G1=new Uint8Array(16);function Q1(){if(!Pd){if(typeof crypto>"u"||!crypto.getRandomValues)throw new Error("crypto.getRandomValues() not supported. See https://github.com/uuidjs/uuid#getrandomvalues-not-supported");Pd=crypto.getRandomValues.bind(crypto)}return Pd(G1)}const Y1=typeof crypto<"u"&&crypto.randomUUID&&crypto.randomUUID.bind(crypto),qy={randomUUID:Y1};function X1(r,e,t){var o;if(qy.randomUUID&&!r)return qy.randomUUID();r=r||{};const s=r.random??((o=r.rng)==null?void 0:o.call(r))??Q1();if(s.length<16)throw new Error("Random bytes length must be >= 16");return s[6]=s[6]&15|64,s[8]=s[8]&63|128,K1(s)}class Ww{constructor(e,t,s,o){this.ProductID=e||X1(),this.ProductName=t,this.ProductDesc=s||"No description provided.",this.ProductPrice=o||0}validate(){if(!this.ProductID)throw new Error("ProductID is required.");if(!this.ProductName)throw new Error("ProductName is required.");if(typeof this.ProductPrice!="number"||this.ProductPrice<0)throw new Error("ProductPrice must be a positive number.");return!0}}function J1(){const r=tf(),[e,t]=q.useState({ProductID:"",ProductName:"",ProductDesc:"",ProductPrice:""}),s=l=>{const{name:h,value:f}=l.target;t(p=>({...p,[h]:f}))},o=async l=>{l.preventDefault();try{const h=new Ww(e.ProductID,e.ProductName,e.ProductDesc,parseFloat(e.ProductPrice));h.validate(),await $1({...h}),alert("Product created successfully!"),r("/")}catch(h){alert(h.message)}};return Ie.jsxs("form",{onSubmit:o,children:[Ie.jsx("input",{type:"text",name:"ProductName",placeholder:"Product Name",value:e.ProductName,onChange:s}),Ie.jsx("input",{type:"text",name:"ProductDesc",placeholder:"Product Description",value:e.ProductDesc,onChange:s}),Ie.jsx("input",{type:"number",name:"ProductPrice",placeholder:"Product Price",value:e.ProductPrice,onChange:s}),Ie.jsx("button",{type:"submit",children:"Create Product"})]})}function Z1(){const{id:r}=VT(),[e,t]=q.useState({ProductID:"",ProductName:"",ProductDesc:"",ProductPrice:""});q.useEffect(()=>{async function l(){const h=await q1(r);h?t(h):alert("Product not found")}l()},[r]);const s=l=>{const{name:h,value:f}=l.target;t(p=>({...p,[h]:f}))},o=async l=>{l.preventDefault();try{const h=new Ww(e.ProductID,e.ProductName,e.ProductDesc,parseFloat(e.ProductPrice));h.validate(),await createProduct({...h}),alert("Product created successfully!")}catch(h){alert(h.message)}};return Ie.jsxs("form",{onSubmit:o,children:[Ie.jsx("input",{type:"text",name:"ProductName",placeholder:"Product Name",value:e.ProductName,onChange:s}),Ie.jsx("input",{type:"text",name:"ProductDesc",placeholder:"Product Description",value:e.ProductDesc,onChange:s}),Ie.jsx("input",{type:"number",name:"ProductPrice",placeholder:"Product Price",value:e.ProductPrice,onChange:s}),Ie.jsx("button",{type:"submit",children:"Create Product"})]})}const eN=q.createContext(),tN=({children:r})=>{const[e,t]=q.useState(null),[s,o]=q.useState(!0);return q.useEffect(()=>Ck(B1,h=>{t(h),o(!1)}),[]),Ie.jsx(eN.Provider,{value:{user:e,loading:s},children:s?Ie.jsx("div",{children:"Loading..."}):r})},nN=()=>Ie.jsx(Ie.Fragment,{children:Ie.jsx(tN,{children:Ie.jsx(_I,{children:Ie.jsxs("div",{children:[Ie.jsx(CI,{}),Ie.jsxs(GT,{children:[Ie.jsx(xu,{path:"/",element:Ie.jsx(W1,{})}),Ie.jsx(xu,{path:"/create",element:Ie.jsx(J1,{})}),Ie.jsx(xu,{path:"/edit/:id",element:Ie.jsx(Z1,{})})]})]})})})});rT.createRoot(document.getElementById("root")).render(Ie.jsx(q.StrictMode,{children:Ie.jsx(nN,{})}));
